...
?>
                                            ...
                                            foreach ($msgarray as $row) {
                                              ...
                                              {
                                                Util::display("<img width='45' height='45' class='rounded-circle img-profile' src='assets/img/avatars/Portrait_Placeholder.png' style='border-color: rgb(255,255,255)!important;'> ");
                                              }
                                              Util::display(
                                                "<strong style='color: var(--bs-yellow);'>$row->user</strong>"
                                              );
                                              Util::display(
                                                " @" . date("h:i", $timestamp)
                                              );
