                            ...
                            <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                                <div class="p-5" style="background: #252935;border-style: none;text-align: center;"><img style="text-align: center;width: 118px;margin-bottom: 33px;" src="assets/img/gey.gif">
                                    ...
                                    <form class="user">
                                        ...
                                        <input class="form-control form-control-user" type="text" id="exampleInputPassword-2" placeholder="Invite" name="invCode" type="text" style="border-radius: 5px;color: rgb(255,255,255);border-style: none;background: #121421;text-align: center;margin-top: 17px;"></div>
                                        <div class="mb-3">
